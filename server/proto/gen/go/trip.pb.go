...
type Trip struct {
	...
	Status      TripStatus `protobuf:"varint,6,opt,name=status,proto3,enum=coolcar.TripStatus" json:"status,omitempty"`
}
...
var file_trip_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x22, 0xc9, 0x01, 0x0a, 0x04,
	...
	0x52, 0x08, 0x73, 0x74, 0x61, 0x72, 0x74, 0x50, 0x6f, 0x73, 0x12, 0x2b, 0x0a, 0x06, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x63, 0x6f, 0x6f,
	0x6c, 0x63, 0x61, 0x72, 0x2e, 0x54, 0x72, 0x69, 0x70, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x20, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x54, 0x72,
	...
	0x10, 0x02, 0x32, 0x4b, 0x0a, 0x0b, 0x54, 0x72, 0x69, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_trip_proto_depIdxs = []int32{
	...
	0, // 1: coolcar.Trip.status:type_name -> coolcar.TripStatus
	2, // 2: coolcar.GetTripResponse.trip:type_name -> coolcar.Trip
	3, // 3: coolcar.TripService.GetTrip:input_type -> coolcar.GetTripRequest
	4, // 4: coolcar.TripService.GetTrip:output_type -> coolcar.GetTripResponse
